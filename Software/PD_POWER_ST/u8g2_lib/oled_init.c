...
uint8_t u8x8_byte_hw_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
	...
	switch (msg)
	{
		...
		{
			if (HAL_I2C_Master_Transmit(&OLED_I2C_Handle, (OLED_ADDRESS), buffer, buf_idx, 1000) != HAL_OK)
				return 0;
		}
		break;
...
{
    u8g2_Setup_ssd1306_i2c_128x64_noname_f(u8g2, U8G2_R0, u8x8_byte_hw_i2c, u8x8_gpio_and_delay_sw); // 初始化 u8g2 结构体
...
//		u8g2_DrawStr(&u8g2, x, y, "software test");
//		if(x >= 70)
//			x = y = 0;
//		else{
//			x++; y++;
